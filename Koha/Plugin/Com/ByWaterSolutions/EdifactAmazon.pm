package Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon;
...
our $metadata = {
    name            => 'Edifact - Amazon',
    author          => 'Kyle M Hall',
    description     => 'Edifact plugin for Amazon',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
