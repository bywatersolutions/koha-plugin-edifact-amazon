...
use Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon::Edifact::Order;
...
sub _new_plugin {
    my (%settings) = @_;
    my $plugin = Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon->new(
...
sub _build_edifact_order {
    ...
    return Koha::Plugin::Com::ByWaterSolutions::EdifactAmazon::Edifact::Order
        ->new(
        {
